...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc '
              '-shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--target=arm-buildroot-linux-gnueabihf' "
                ...
                "'--with-expat=none' '--disable-sqlite3' '--disable-openssl' "
                ...
                "'--with-build-python=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3' "
                ...
                "'CPP=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-cpp'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2/lcov-report',
 ...
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-g++',
 ...
 'DISABLED_EXTENSIONS': 'pyexpat _decimal ossaudiodev _sqlite3 _codecs_kr '
                        ...
                        'zlib _lzma _tkinter _uuid _dbm',
 ...
 'FREEZE_MODULE': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-g++ '
                '-shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc '
             '-shared',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc',
 ...
 'MAINCC': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/../arm-buildroot-linux-gnueabihf/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '',
 'MODULE_ZLIB_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/../arm-buildroot-linux-gnueabihf/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/../arm-buildroot-linux-gnueabihf/sysroot/usr/lib    '
                            '-lcrypto',
 ...
 'MODULE__SSL_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/../arm-buildroot-linux-gnueabihf/sysroot/usr/lib   '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '',
 'OPENSSL_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/../arm-buildroot-linux-gnueabihf/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_arm-linux-gnueabihf '
                     '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'READELF': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/arm-none-linux-gnueabihf-readelf',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2/`cat '
               'pybuilddir.txt`:)./Lib '
               ...
               '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2/`cat '
               'pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2',
 'abs_srcdir': '/home/jonathan/work/bbb/buildroot/output/build/python3-3.11.2',
