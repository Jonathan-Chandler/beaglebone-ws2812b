...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin',
 'BINLIBDEST': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/usr/bin/gcc -shared '
              '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
              '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
              '-Wl,--enable-new-dtags',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
           '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'CONFIGURE_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                      '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                      '-Wl,--enable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain' "
                "'--sysconfdir=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/etc' "
                "'--localstatedir=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/var' "
                ...
                "'PKG_CONFIG=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/bin/pkg-config' "
                "'PKG_CONFIG_LIBDIR=/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/pkgconfig:/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/share/pkgconfig' "
                "'CC=/usr/bin/gcc' 'CFLAGS=-O2 "
                "-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include' "
                "'LDFLAGS=-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib "
                '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                "-Wl,--enable-new-dtags' "
                "'CPPFLAGS=-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include' "
                "'CPP=/usr/bin/cpp'",
 'CONFINCLUDEDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'CONFINCLUDEPY': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2/lcov-report',
 ...
 'DESTDIRS': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain '
             '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
             '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11 '
             '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11/lib-dynload',
 'DESTLIB': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include '
                   '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include '
                   '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include/python3.11 '
                   '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include/python3.11',
 'INCLUDEDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'INCLUDEPY': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11',
 'LIBDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/pkgconfig',
 'LIBPL': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/usr/bin/gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'MODULE_BINASCII_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include',
 'MODULE_ZLIB_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                        '-lz',
 ...
 'MODULE__UUID_CFLAGS': '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include/uuid',
 'MODULE__UUID_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                         '-luuid',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -O2 '
                   ...
                   '-I/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                    '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                    '-Wl,--enable-new-dtags',
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
               '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
               '-Wl,--enable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                     '-Wl,-rpath,/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib '
                     '-Wl,--enable-new-dtags',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2',
 'SCRIPTDIR': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './home/jonathan/work/bbb/beaglebone-ws2812b/toolchain',
 'WASM_STDLIB': './home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2',
 'abs_srcdir': '/home/jonathan/work/bbb/buildroot/output/build/host-python3-3.11.2',
 'datarootdir': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain/share',
 'exec_prefix': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain',
 'prefix': '/home/jonathan/work/bbb/beaglebone-ws2812b/toolchain',
 'srcdir': '.'}
